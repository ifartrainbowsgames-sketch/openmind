...
log ""
log "Next steps:"
log "  1. Get a sandbox key (E2B recommended if Daytona fails):"
log "       https://e2b.dev/dashboard?tab=keys"
log "  2. export E2B_API_KEY=e2b_... && ./configure-sandbox.sh e2b"
log "  3. kortix self-host configure   (GitHub token + LLM keys)"
log "  4. kortix self-host open"
log ""
